...
<body>
  <div class='mainWrapper'>
    <h1 class='title'>クイズ設問削除ページ</h1>
    <form action="/admin/question_del" method="POST">
      <table>
        @csrf
        <input type="hidden" name="id" value="{{$form->id}}">
        <tr><th>image_name: {{$form->image_name}}</th><td><input type="text" name="image_name" value="{{$form->image_name}}"></td></tr>
